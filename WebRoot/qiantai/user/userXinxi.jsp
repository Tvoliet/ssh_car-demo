				    ...
				    <form action="<%=path %>/userEdit.action" name="form1" method="post">
	                     <table align="left" border="0" cellpadding="4" cellspacing="4">
							<tr align='center'>
								...
								<td align="left">
									<input type="text" name="loginname" style="width: 200px;" value="${sessionScope.user.loginname }" readonly="readonly"/>
								    (账号只读)
								</td>
							</tr>
							<tr align='center'>
								...
								<td align="left">
									<input type="password" name="loginpw" style="width: 200px;" value="${sessionScope.user.loginpw }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
								...
								<td align="left">
									<input type="text" name="name" style="width: 200px;" value="${sessionScope.user.name }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
							...
							<tr align='center'>
								...
								<td align="left">
									<input type="text" name="age" style="width: 200px;" value="${sessionScope.user.age }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
								...
								<td align="left">
									<input type="text" name="address" style="width: 200px;" value="${sessionScope.user.address }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
								...
								<td align="left">
									<input type="text" name="tel" style="width: 200px;" value="${sessionScope.user.tel }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
								...
								<td align="left">
									<input type="text" name="email" style="width: 200px;" value="${sessionScope.user.email }"/>
								</td>
							</tr>
							<tr align='center'>
								<td style="width: 50px;" align="center">
							...
							<tr align='center'>
							   ...
							   <td align="left">
							      ...
							      <input type="button" value="修改" style="width: 60px;height: 22px;" onclick="zhuce();">
